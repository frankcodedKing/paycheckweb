      ...
      >
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            Receive money from the diaspora conveniently, and swiftly. 
            </p>
            ...
            <ul class="mt-8 flex gap-6">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  class="text-white transition hover:opacity-75 text-gray-200"
                >
          ...
          <div className='text-white text-left flex'>
            ...
            <ul className='text-left flex-1'>
              ...
              <li className='py-2 text-sm'>Paycheckng@paycheck.com</li>
              <li className='py-2 text-sm'>+32947685236</li>
            </ul>
        ...
        <p class="text-xs text-gray-500 text-gray-400">
          &copy; 2023. Paycheck All rights reserved.
        </p>
      </div>
    </footer>
